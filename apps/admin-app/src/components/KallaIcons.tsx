...
// ==== Admin-app'e özgü ek sekme ikonları ====

export const TabBranchesIcon: React.FC<KallaIconProps> = ({ size = 15, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Path d="M12,2 C8.13,2 5,5.13 5,9 C5,14.25 12,22 12,22 C12,22 19,14.25 19,9 C19,5.13 15.87,2 12,2 Z" />
    <Circle cx="12" cy="9" r="3" />
  </Svg>
...
export const TabStaffIcon: React.FC<KallaIconProps> = ({ size = 15, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Circle cx="9" cy="7" r="3" />
    <Path d="M3,20 C3,16 5.5,14 9,14 C12.5,14 15,16 15,20" />
    <Circle cx="17" cy="8" r="2.3" />
    <Path d="M15.5,14.3 C18.2,14.6 20,16.4 20,19.5" />
  </Svg>
);
