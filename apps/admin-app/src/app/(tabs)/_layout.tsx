...
import { TabBranchesIcon, TabShiftsIcon, TabSalesIcon, TabStaffIcon } from '../../components/KallaIcons';
...
export default function TabsLayout() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        <Tabs.Screen name="index" options={{ tabBarLabel: 'Şubeler', tabBarIcon: tabIcon(TabBranchesIcon) }} />
        <Tabs.Screen name="shifts" options={{ tabBarLabel: 'Vardiyalar', tabBarIcon: tabIcon(TabShiftsIcon) }} />
        <Tabs.Screen name="sales" options={{ tabBarLabel: 'Z Raporları', tabBarIcon: tabIcon(TabSalesIcon) }} />
        <Tabs.Screen name="staff" options={{ tabBarLabel: 'Personel', tabBarIcon: tabIcon(TabStaffIcon) }} />
      </Tabs>
    </View>
  );
}
