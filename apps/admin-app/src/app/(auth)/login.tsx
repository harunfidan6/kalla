    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <GlassView blurType="heavy" style={[styles.card, { borderColor: colors.border }]}>
        <View style={styles.brandHeader}>
          ...
          <Text style={[styles.roleLabel, { color: colors.textMuted, fontFamily: Fonts.uiExtraBold }]}>YÖNETİM</Text>
        ...
        <Text style={[styles.title, { color: colors.text, fontFamily: Fonts.displayItalic }]}>Yönetici Girişi</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary, fontFamily: Fonts.ui }]}>
          Şube yönetimi, vardiya atama ve Z Raporu görüntüleme sistemine erişmek için oturum açın.
        </Text>
