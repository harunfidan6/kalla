...
// --- Bottom tab bar icons — exact paths from the design handoff's tab bar (simpler/smaller
// than the icons above, purpose-built for the 15x15 tab bar rendering) ---

export const TabMenuIcon: React.FC<KallaIconProps> = ({ size = 24, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Rect x="4" y="3" width="16" height="18" rx="2" />
    <Line x1="8" y1="3" x2="8" y2="21" />
...
export const TabOrdersIcon: React.FC<KallaIconProps> = ({ size = 24, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Path d="M12,6 L18,9 L12,12 L6,9 Z" />
    <Path d="M6,9 L6,17 L12,20 L12,12 Z" />
    <Path d="M18,9 L18,17 L12,20 L12,12 Z" />
...
export const TabWalletIcon: React.FC<KallaIconProps> = ({ size = 24, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Rect x="2" y="5" width="20" height="14" rx="2" />
    <Line x1="2" y1="9" x2="22" y2="9" />
    <Rect x="5" y="12" width="4" height="3" rx="0.5" />
...
export const TabNotificationsIcon: React.FC<KallaIconProps> = ({ size = 24, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Path d="M21,15 C21,16.1 20.1,17 19,17 L7,17 L3,21 L3,5 C3,3.9 3.9,3 5,3 L19,3 C20.1,3 21,3.9 21,5 Z" />
...
export const TabProfileIcon: React.FC<KallaIconProps> = ({ size = 24, color = '#87A99C', ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <Circle cx="12" cy="7" r="4" />
    <Path d="M5,19 C5,15 8,13 12,13 C16,13 19,15 19,19" />
  </Svg>
