...
// (per the redesign spec — this is the key visual difference from the old dark-only theme,
// where borders were always white); dark mode keeps the original white-border glass look.
